...
b
```
5. ## The highest mean years of education is for those who answered with no answer. Never married has on average about .4 more years of education than married. While seperated's average is more than 1 whole year below married and widowed is nearly two. The low years of education for widowed could imply the military is involved.
```{r}
